...
function isShadowRoot(e) {
  return e instanceof getWindow(e).ShadowRoot || e instanceof ShadowRoot;
}
...
function detectOverflow(e, t) {
  ...
  var r,
    ...
    P = rectToClientRect(Object.assign(Object.assign({}, b), E)),
    x = f === popper ? P : w,
    S = {
...
function popperGenerator(e) {
  ...
  var t = e.defaultModifiers,
    s = void 0 === t ? [] : t,
    n = e.defaultOptions,
    p = void 0 === n ? DEFAULT_OPTIONS : n;
  return function (r, o, t) {
    void 0 === t && (t = p);
    var f = {
        placement: "bottom",
        orderedModifiers: [],
        options: Object.assign(Object.assign({}, DEFAULT_OPTIONS), p),
        modifiersData: {},
        ...
        setOptions: function (e) {
          i(),
            (f.options = Object.assign(
              Object.assign(Object.assign({}, p), f.options),
              e
            )),
            (f.scrollParents = {
          ...
          var t,
            n = orderModifiers(mergeByName([].concat(s, f.options.modifiers)));
          return (
            (f.orderedModifiers = n.filter(function (e) {
              return e.enabled;
            })),
            "production" !== process.env.NODE_ENV &&
              (validateModifiers(
                uniqueBy([].concat(n, f.options.modifiers), function (e) {
                  return e.name;
                })
              ),
              getBasePlacement(f.options.placement) === auto &&
            ...
            f.orderedModifiers.forEach(function (e) {
              var t,
                ...
                i = e.effect;
              "function" == typeof i &&
                ((t = i({ state: f, name: n, instance: d, options: o })),
                a.push(t || function () {}));
            }),
            d.update()
          );
        ...
        forceUpdate: function () {
          if (!l) {
            ...
            if (areValidElements(t, n)) {
              ...
              for (
                var r, o, i, a, s, p = 0, c = 0;
                c < f.orderedModifiers.length;
                c++
              ) {
                if ("production" !== process.env.NODE_ENV && 100 < (p += 1)) {
                  console.error(INFINITE_LOOP_ERROR);
                  break;
                }
                !0 !== f.reset
                  ? ((o = (r = f.orderedModifiers[c]).fn),
                    (a = void 0 === (i = r.options) ? {} : i),
                    (s = r.name),
                    "function" == typeof o &&
                      (f =
                        o({ state: f, options: a, name: s, instance: d }) || f))
                  : ((f.reset = !1), (c = -1));
              }
            } else
              "production" !== process.env.NODE_ENV &&
...
function effect(e) {
  ...
  return (
    ...
    s && p.addEventListener("resize", n.update, passive),
    function () {
      i &&
        c.forEach(function (e) {
          e.removeEventListener("scroll", n.update, passive);
        }),
        s && p.removeEventListener("resize", n.update, passive);
    }
  );
}
var eventListeners = {
...
function mapToStyles(e) {
  ...
  c &&
    ...
    i === top &&
      ((h = bottom), (d -= n.clientHeight - o.height), (d *= p ? 1 : -1)),
    i === left &&
      ((g = right), (l -= n.clientWidth - o.width), (l *= p ? 1 : -1)));
  var b,
    y = Object.assign({ position: s }, c && unsetSides);
  return p
    ? Object.assign(
        Object.assign({}, y),
        {},
  ...
  if (!n.modifiersData[r]._skip) {
    for (
      ...
      var R = y[S],
        ...
        T = D ? (N ? right : left) : N ? bottom : top;
      O[j] > w[j] && (T = getOppositePlacement(T));
      var I = getOppositePlacement(T),
        C = [];
      if (
        (i && C.push(L[M] <= 0),
        s && C.push(L[T] <= 0, L[I] <= 0),
        C.every(function (e) {
          return e;
        }))
      ) {
...
function preventOverflow(e) {
  var t,
    ...
    q = getBasePlacement(N.placement),
    G = getVariation(N.placement),
    U = !G,
    X = getMainAxisFromPlacement(q),
    Y = getAltAxis(X),
  ...
  z &&
    (T &&
      ...
      (c = G === start ? -K[r] : -J[r]),
      (f = N.elements.arrow),
      (l = k && f ? getLayoutRect(f) : { width: 0, height: 0 }),
      (u = (d = N.modifiersData["arrow#persistent"]
        ? N.modifiersData["arrow#persistent"].padding
        : getFreshSideObject())[t]),
      (m = d[n]),
      (g = within(0, J[r], l[r])),
      (h = U ? J[r] / 2 - s - g - u - Q : p - g - u - Q),
      (v = U ? -J[r] / 2 + s + g + m + Q : c + g + m + Q),
      (y = (b = N.elements.arrow && getOffsetParent(N.elements.arrow))
        ? "y" === X
          ? b.clientTop || 0
          : b.clientLeft || 0
        : 0),
...
function arrow(e) {
  var t,
    ...
    h = e.name,
    v = g.elements.arrow,
    b = g.modifiersData.popperOffsets,
  ...
  v &&
    ...
    (i = "y" === O ? bottom : right),
    (a =
      g.rects.reference[w] + g.rects.reference[O] - b[O] - g.rects.popper[w]),
    (s = b[O] - g.rects.reference[O]),
    (c = (p = getOffsetParent(v))
      ? "y" === O
        ? p.clientHeight || 0
        : p.clientWidth || 0
      : 0),
...
function hide(e) {
  ...
  (t.modifiersData[n] = {
    ...
    (t.attributes.popper = Object.assign(
      ...
      {},
      { "data-popper-reference-hidden": f, "data-popper-escaped": l }
    ));
}
var hide$1 = {
    name: "hide",
